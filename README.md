...
* [decky-toy-haptics](https://github.com/madrigal-eschat/decky-toy-haptics) is a Decky Loader plugin to provide a one-click install Steam Deck game-mode interface for routing game haptics to your intimate devices.
